<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">Form Penilai - Kelas</h3>
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="alert bg-purple">
                    ...
                    <br><br>
                    <ol class="pl-4">
                        <li>Anda belum menambahkan master data penilai (Master penilai kosong/belum ada data sama sekali).</li>
                        <li>Penilai sudah ditambahkan, jadi anda tidak perlu tambah lagi. Anda hanya perlu mengedit data kelas dosen nya saja.</li>
                    </ol>
                </div>
            </div>
            <div class="col-sm-4">
