        ...
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
                ...
                <div class="form-group">
                    ...
                    <input value="<?=$data->nama_dosen?>" type="text" class="form-control" name="nama_dosen" placeholder="Nama Penilai">
                    <small class="help-block"></small>
                </div>
                <div class="form-group">
                    <label for="email">Email Penilai</label>
                    <input value="<?=$data->email?>" type="text" class="form-control" name="email" placeholder="Email Penilai">
                    <small class="help-block"></small>
                </div>
                <div class="form-group">
