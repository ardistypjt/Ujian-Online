...
class Kelas extends CI_Controller
{
	...
	{
		$chk = $this->input->post('checked', true); //validasi kayak cek rules
		if (!$chk) {
			redirect('admin/kelas');
		} else {
			$kelas = $this->master->getKelasById($chk); //ngambil data sesuai ID
			$data = [
				'user' 		=> $this->ion_auth->user()->row(),
				'judul'		=> 'Edit Kelas',
				'subjudul'	=> 'Edit Data Kelas',
				'jurusan'	=> $this->master->getAllJurusan(),
				'kelas'		=> $kelas //narok variabel $kelas disini biar bisa dimunculin ndek view
			];
			$this->load->view('_templates/dashboard/_header.php', $data); //munculin array $data ndek view
